...
| file | what |
|---|---|
| `01_water_rks.py` | closed-shell KS on water, all four functionals (LDA/PBE/PBE0/B3LYP) |
| `02_ch3_uks.py` | open-shell (spin-polarized) KS on the CH₃ radical (PBE, B3LYP) |
